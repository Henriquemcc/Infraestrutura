...
docker run -it -e DB_NAME=mastodon \
  ...
  --name mastodon_tmp \
  ghcr.io/mastodon/mastodon:v4.4.4 bash -c "RAILS_ENV=production; bin/tootctl accounts create \"${MASTODON_ADMIN_USERNAME}\" --email \"${MASTODON_ADMIN_EMAIL}\" --confirmed --role admin"
